...
HD_PWD='C:/projets_polytech/VHDL_Icobs_Project/Hardware/ICOBS_light_PROJECT_DIR/ICOBS_light_PROJECT_DIR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ICOBS_light_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ICOBS_light_TOP.tcl -notrace
