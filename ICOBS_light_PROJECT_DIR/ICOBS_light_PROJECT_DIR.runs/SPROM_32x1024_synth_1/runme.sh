...
HD_PWD='C:/projets_polytech/VHDL_Icobs_Project/Hardware/ICOBS_light_PROJECT_DIR/ICOBS_light_PROJECT_DIR.runs/SPROM_32x1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPROM_32x1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPROM_32x1024.tcl
