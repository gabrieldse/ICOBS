...
HD_PWD='C:/projets_polytech/VHDL_Icobs_Project/Hardware/ICOBS_light_PROJECT_DIR/ICOBS_light_PROJECT_DIR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ICOBS_light_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ICOBS_light_TOP.tcl
